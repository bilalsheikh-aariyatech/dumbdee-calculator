          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-secondary p-4 rounded-lg">
                ...
                <div className="text-2xl font-bold text-secondary-foreground">₹{result.marketPrice.toFixed(2)}</div>
              </div>

              <div className="bg-secondary p-4 rounded-lg">
                <div className="text-sm text-secondary-foreground/70">Seller Price</div>
                <div className="text-2xl font-bold text-secondary-foreground">₹{result.sellerPrice.toFixed(2)}</div>
              </div>

              <div className="bg-secondary p-4 rounded-lg">
                <div className="text-sm text-secondary-foreground/70 flex items-center gap-2">
                  Price Difference
                  <Badge variant={result.difference > 0 ? "default" : "destructive"} className="text-xs">
              ...
              <div className="bg-accent p-4 rounded-lg">
                ...
                <div className="text-2xl font-bold text-accent-foreground">{result.dumbdeePercentage}%</div>
              </div>
            </div>
